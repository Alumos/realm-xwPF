...
─────────────────────────────────────────────────────────────────
Completed: 2025-08-28 20:12:29 | Source: https://github.com/Alumos/realm-xwPF
```
...
```bash
wget -qO- https://v6.gh-proxy.org/https://raw.githubusercontent.com/Alumos/realm-xwPF/main/xwPF.sh | sudo bash -s install
```
...
- **Main script**: [xwPF.sh](https://github.com/Alumos/realm-xwPF/raw/main/xwPF.sh)
- **Module files** (all required): https://github.com/Alumos/realm-xwPF/tree/main/lib
...
- **More Projects:** [https://github.com/Alumos](https://github.com/Alumos)
- **Homepage:** [https://zywe.de](https://zywe.de)
- **Bug Reports:** [GitHub Issues](https://github.com/Alumos/realm-xwPF/issues)
